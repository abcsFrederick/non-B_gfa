...
remote_url <- git("remote get-url origin", echo_cmd = FALSE)$stdout |>
    trimws()

action_url <- str_replace(remote_url, fixed('.git'), '/actions/workflows/R-CMD-check.yml')
badge_url <- paste0(action_url, '/badge.svg')
```

<!-- badges: start -->
[![R-CMD-check](`r badge_url`)](`r action_url`)
<!-- badges: end -->
